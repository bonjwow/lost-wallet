...
The selection of countries raises another issue of the dataset: Do those countries really represent the globe? 40 countries are selected and examined for the research, and almost half (19 countries) of them are European countries. However, in reality, the population of all European countries is approximately 10% of the world's population [@citeWorldContinents]. In terms of the number of countries, there are merely 44 countries in Europe, out of 195 countries in the world, which accounts for about one-fourth of the total countries [@citeCountriesEurope]. Is it because those unselected countries could not meet the requirements of selection criteria? The selection criteria requirements for the country category are as follows:
